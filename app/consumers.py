...
class MyAsyncConsumer(AsyncConsumer):
    ...
    async def websocket_connect(self,event):
        ...
        await self.channel_layer.group_add("PROGRAMMERS",self.channel_name) #creating the grup with multiple instances
        await self.send(
    ...
    async def websocket_disconnect(self,event):
        ...
        self.channel_layer.group_discard("PROGRAMMERS GUYS",self.channel_name)
        raise StopConsumer()
